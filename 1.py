...
author = 'Galirus_404'
git_hub = 'https://github.com/Galirus404'
faceb0ok = 'Galirus-Official'
...
###---[ANGGAP INI LOGO ]---###
def logo(n):
	return str(f"""  ________           _____________
___  __ \______ _____  /___  __/
__  /_/ /_  __ `__ \  __/_  /_  
_  _, _/_  / / / / / /_ _  __/  
/_/ |_| /_/ /_/ /_/\__/ /_/     
 selamat datang {kk}{n}{P}, Create {kk}Galirus-404{hh} Play Four User""")
def logo2():
	return str(f"""  ________           _____________
___  __ \______ _____  /___  __/
__  /_/ /_  __ `__ \  __/_  /_  
_  _, _/_  / / / / / /_ _  __/  
/_/ |_| /_/ /_/ /_/\__/ /_/  
 selamat datang {kk}user{P}, Create {kk}Galirus-404{hh} Play Four User""")
...
def menu(n,t,c):
	...
	print(logo(n)+f'\n')
	print(' ─────────────────────────────')
	print(f" [{hh}01{P}] Crack publik")
	print(f" [{hh}02{P}] Crack massal")
	print(f" [{hh}03{P}] Crack Folowers")
	print(f" [{hh}04{P}] Crack Komentar ")
	print(f" [{hh}05{P}] Crack Group")
	print(f" [{hh}06{P}] Crack E-mail")      
	print(f" [{hh}07{P}] Crack search")
	print(f" [{hh}08{P}] Crack Dari File")
	print(f" [{hh}09{P}] Chek Hasil Akun")
	print(f" [{hh}10{P}] Cek Akun KN")
	print(f" [{hh}11{P}] Cek Opsi Akun")
	print(f" [{hh}12{P}] Out Sc  ({M}Cookies{P})")
